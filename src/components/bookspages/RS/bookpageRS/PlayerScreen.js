...
const PlayerScreen = ({ chapterDetail }) => {
  const audiLink = (number) => number < 10 ? (
    "https://aatry1000.s3.amazonaws.com/Books/RS/0"+ number +"+Riyaadus-saalixiin.mp3") : (

      "https://aatry1000.s3.amazonaws.com/Books/RS/"+ number +"+Riyaadus-saalixiin.mp3")
      ...
      {chapterDetail !== null ? (
        <ul className='list-group text-end'>
          <div>
            ...
            ><br></br>
              <span className='fw-bold'>Riyadu Salixiin</span>{" "}
            </li>
        ...
        <div className=' bg-red list-group-item home-body2'>
          <span className='fw-bold'><br></br>Riyadu Salixiin</span>{" "}<br></br>
        </div>
      )}
    </div>
  );
